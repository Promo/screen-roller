(function($){
    ...
    var ScreenRoller = {
        init: function(el, options) {
            ...
            el.setTransform = this.setTransform.bind(this);
        ...
        getNextScreen: function(direction) {
            ...
            if(typeof direction  === 'string') {
                nextIndexScreen = (direction === 'up') ? this.currentScreen - 1 : this.currentScreen + 1;
            }
        ...
        setTransform: function(value) {
            ...
            this.axis === 'x' ? offset.x = value : offset.y = value;

            this.el.css('transform', 'translate3d(' + offset.x + 'px, ' + offset.y + 'px, 0)');
        },
