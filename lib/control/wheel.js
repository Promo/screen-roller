(function($){
    ...
    var Wheel = {
        init: function() {
            ...
            roller.onWatcherWheel  = module.onWatcherWheel.bind(module);
            roller.offWatcherWheel = module.offWatcherWheel.bind(module);

            module.onWatcherWheel();
        },

        onWatcherWheel: function() {
            var module = this,
                el = this.el;
