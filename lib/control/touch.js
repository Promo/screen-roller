(function($){
    var Touch = {
        ...
        touchEnd: function(commonDirection, lastDirection) {
            var currentScreen = this.roller.currentScreen,
                countScreens = this.roller.countScreens - 1,
                speed = this.roller.options.speedanimation,
                el = this.el;
        ...
        getCurrentPosition: function(e) {
            var axis = this.roller.options.axis;
