(function($){
    var SolidMod = {
        init: function () {
            ...
            module.options = roller.options.modules['solid-mod'];

            module.options.minHeight = module.options.minHeight || 500;
            module.options.minWidth = module.options.minWidth || 700;

            module.options.onSolidMod = module.options.onSolidMod || function(){};
            module.options.offSolidMod = module.options.offSolidMod || function(){};
        ...
        processWindowResize: function () {
            var module = this,
                ...
                minHeight  = module.options.minHeight,
                minWidth   = module.options.minWidth,
        ...
        processWindowScroll: function(scrollTop) {
            ...
            if(nearestToTop !== roller.currentScreen) {
                ...
                roller.beforeChangeSlide(nearestToTop);
                roller.afterChangeSlide(nearestToTop);
            }
        },
