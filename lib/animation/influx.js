(function($){
    var InfluxAnimation = {
        ...
        init: function() {
            ...
            this.setInitialPosition(roller.options.influxDirectionAnimation);
        ...
        bindEventsInfluxAnimation: function() {
            ...
            el.on('turnOnScreenMod', function() {
                roller.setInitialPosition(roller.influxDirectionAnimation);
            });
        },
        ...
        setDirection: function(index) {
            var roller = this.roller,
                influxDirectionAnimation = roller.options.influxDirectionAnimation,
                reverseDirettion   = this.reverseDirections;

            if(index < roller.currentScreen) {
                influxDirectionAnimation = reverseDirettion[influxDirectionAnimation]
            }

            this.setInitialPosition(influxDirectionAnimation);
        },
