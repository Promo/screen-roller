(function($){
    var InfluxAnimation = {
        ...
        init: function() {
            var module = this,
                roller = this.roller,
                options = roller.options.modules['influx-animation'];
            ...
            module.direction            = options['direction'] || 'from-right';
            module.reverseAnimation     = options['reverseAnimation'];
        ...
        influxAnimateTransform: function(index, speed) {
            ...
            module.reverseAnimation && module.setDirection(index);
